...
@section('content')
    ...
    <section class="features_causes mt-5 pt-5 pb-5 px-0" id="about">
        <div class="container pt-5">
            ...
            <div class="col-sm-8 text-center pb-3" dir="rtl">
                <h3>به همین راحتی</h3>
                <p>
                    ایده‌ی اولیه‌ی این حساب، از دیوارهای مهربانی گرفته شده است.<br>
                    مردم مهربان و خونگرم ایران به کرات اثبات کرده‌اند که پشت هموطنان خود را خالی نمی‌کنند و حواسشان به قشر نیازمند جامعه هست. در همین راستا، حساب مهربانی برای تسریع در فرایند همیاری و کمک‌رسانی به این هموطنان ایجاد شده است.<br>
                </p>
            </div>
            </div>
        </div>
    ...
    <section class="features_causes mt-5 pt-5 pb-5 mb-5 px-0" id="causes">
        <div class="container pt-5">
            ...
            <div class="row" dir="rtl">
                ...
                $texts = [
                    'افراد بسیاری هستند که مدت‌هاست تغذیه مناسبی نداشته و دچار سوءتغذیه شده‌اند.در همین راستا از تمام شما مهربانان درخواست می‌کنیم اگر امکان کمک به حل مشکل تغذیه‌ای هم‌وطنانمان را دارید، همراهی‌مان کنید.',
                    'بیماری انسان‌های نیازمند علاوه بر درد و رنج، نگرانی تامین هزینه‌های سنگین و ویران‌کننده آن را نیز به دنبال دارد که خارج از توان آن‌هاست. این افراد علی‌رغم میل باطنی، به دلیل بیماری ،کهولت ،از کار افتادگی و .... توان اداره زندگی خود را  را نیز نداشته و لذا نیازمند یاری شما هستند.',
                    'متاسفانه افراد زیادی از هموطنانمان هستند که از پوشاک مناسب برخوردار نیستند و در سرمای پاییز و زمستان دچار مشکل می‌شوند. این شرایط مخصوصا برای نوزدان و سالمندان سخت می‌شود. به فکرشان باشیم.',
                    'همگی از وضعیت مسکن مطلع هستیم. اجاره خانه‌هایی که ماه‌هاست عقب افتاده و اثاثیه‌ای که هر لحظه ممکن است به کوچه ریخته شود. یاری‌شان کنیم.',
                    'همه ما لذت خرید مداد و پاک‌کن و دفتر و جلد کردن کتاب‌هایمان را قبل از باز شدن مدارس چشیده‌ایم. حالا می‌توانیم این لذت را به کودکان نیازمند هدیه کنیم.',
                    'ازدواج مشکل است و طولانی شدن نامزدی به علت آماده نبودن جهیزیه آن را سخت‌تر می‌کند. چه خانواده‌های آبرومندی که تنها به خاطر کمبود مالی برای تهیه جهیزیه دچار مشکل می‌شوند. تنهایشان نگذاریم.',
                ];
                ?>
                                    ...
                                    <div class="py-1">
                                        <div class="my-3" style="min-height: 30px;">
                                            <div class="text-right float-right">
                                                <span class="label label-primary">تعداد کمک‌های انجام‌شده:
                                                    <span id="count-{{$i}}" data-val="{{$category['count']}}">0</span>
                                                </span>
                                            </div>
