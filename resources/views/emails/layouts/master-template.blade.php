                                                ...
                                                <td class="mcnTextBlockInner"
                                                    ...
                                                    <table style="max-width: 100%;min-width: 100%;border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="mcnTextContent"
                                                                style="padding: 0px 18px 9px;color: #000000;font-size: 16px;font-style: normal;font-weight: bold;text-align: center;mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;word-break: break-word;font-family: Tahoma;line-height: 150%;"
                                                                valign="top">
                                                ...
                                                <td class="mcnTextBlockInner"
                                                    ...
                                                    <table style="max-width: 100%;min-width: 100%;border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="mcnTextContent"
                                                                style="padding:25px;font-size: 18px;mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;word-break: break-word;color: #808080;font-family: Tahoma;line-height: 150%;text-align: center; direction: rtl"
                                                                valign="top">
                                                                @yield('content')
                                                                {{--<p>--}}
                                                                ...
                                                                {{--شما در سایت سنجمان با ایمیلtiva1store@gmail.com ثبت--}}
                                                                {{--نام کردید. لطفا برای تایید ایمیل خود، بر روی دکمه--}}
                                                                {{--زیر کلیک کنید.--}}
                                                                {{--فعالسازی حساب--}}

                                                                {{--در اسرع وقت با شما تماس خواهیم گرفت..--}}

                                                                {{--اگر فکر میکنید اشتباهی رخ داده، این ایمیل را نادیده--}}
                                                                {{--بگیرید--}}

                                                                {{--</p>--}}
                                                                {{--<a href="#">لینک فعال سازی</a>--}}
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                ...
                                                <td class="mcnTextBlockInner"
                                                    ...
                                                    <table style="max-width: 100%;min-width: 100%;border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="mcnTextContent"
                                                                style="padding: 0px 18px 9px;color: #FFFFFF;font-size: 18px;font-style: normal;font-weight: normal ;mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;word-break: break-word;font-family: tahoma;line-height: 150%;text-align: center;"
                                                                valign="top">
